...
variables corresponding to a particular set of interpolation dimensions must
be separately associated with their corresponding interpolation
variables according to which corresponding tie point interpolation dimension
